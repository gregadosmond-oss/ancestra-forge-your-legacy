...
const CONFIG = {
  ...
  emoji: "📖",
  desc: "A hardcover heirloom of your full family story — your custom coat of arms, all 9 chapters, your visual bloodline tree, and your migration path. Bound matte-laminated hardcover on coated silk. Printed and shipped worldwide via Gelato. Includes the full digital Legacy Pack.",
};

export default function LegacyBookOrderPage() {
  usePageMeta({
    title: "Order Your Legacy Book | AncestorsQR",
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center" style={{ background: "#0d0a07" }}>
      ...
      <div className="relative z-10 w-full max-w-xl px-6 py-20">
        <SectionLabel>LEGACY BOOK ORDER</SectionLabel>
          ...
          >
            ...
            >
              ...
              <h2
                ...
                style={{ color: "#f0e8da" }}
              >
                Your Legacy Book is being forged.
              </h2>
              <p className="mx-auto mt-4 max-w-md font-serif italic" style={{ color: "#c4b8a6" }}>
                Ships in 7–10 business days. We'll email you tracking once it leaves the press.
              </p>
              <div className="mt-10 flex justify-center gap-4">
                <Link
                  to="/"
                  className="inline-block rounded-pill px-10 py-4 font-sans text-[13px] font-semibold uppercase tracking-[1.5px] transition-all duration-300 hover:-translate-y-0.5"
            ...
            {step === "details" ? (
              ...
              >
                ...
                <p className="text-center font-sans text-[10px]" style={{ color: "#8a7e6e" }}>
                  Includes full digital Legacy Pack · Ships in 7–10 business days · Worldwide delivery
                </p>
              </motion.form>
            ) : (
              <motion.div
